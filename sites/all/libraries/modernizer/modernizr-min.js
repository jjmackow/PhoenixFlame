...
<head>
   ...
   <!--[if (gt IE 7)|!(IE)]><!--><link rel="stylesheet" href="/i/css/modernizr-2.1.2.css?v=20140317" type="text/css" media="screen"><!--<![endif]-->
  ...
  <div class="page">
     ...
     <div class="container clrfx">
        ...
        <aside class="quote">
           ...
           <cite>Bruce Bowman, sr. product manager, Edge Tools & Services</cite>
        </aside>
        ...
        <div id="content" class="clrfx">
           ...
           <div id="primary" class="clrfx" role="main">
               ...
               <h2><a href="/download/" class="wt dl-link">Download Modernizr 2.7.1</a></h2>
               ...
               <form action="#" class="builder">
                  ...
                  <fieldset class="features" id="group-plugins">
                     ...
                     <ul>
                       <li id="shiv"><label><input type="checkbox" checked value="shiv" /> html5shiv v3.7</label></li>
                       <li id="printshiv"><label><input type="checkbox" value="printshiv" /> html5shiv v3.7.1 w/ printshiv</label></li>
        ...
        <script src="/i/js/builderapp.min.js?sept3" async data-currentbuildversion="2.7.1"></script>
           ...
           <div id="secondary" class="clrfx" role="complementary">
					...
					<article>
						<footer><time datetime="2012-09-04T20:35:20">April 2nd, 2013</time></footer>
						<h3><a href="/news/modernizr-v3-stickers-diversity/" class="permalink bookmark">Modernizr 3, Stickers &amp; Diversity</a></h3>
						<p>News on v.3, stickers, and a message from the team.</p>
					</article>

					<h4>Previous</h4>

					<article>
						<footer><time datetime="2012-09-04T20:35:20">January 7th, 2013</time></footer>
						<h3><a href="/news/modernizr-policy-feature-detects/" class="permalink bookmark">Modernizr Policy on Browser Bugs and Feature Detects</a></h3>
					</article>
      ...
      <section id="team">
         ...
         <div class="container">
            ...
            <ul class="clrfx">
               ...
               <li class="team"><a class="wt" href="http://www.stucox.com/"><img src="/i/img/Stu-Cox-48.jpg" width="48" height="48" alt=""/>Stu Cox</a> <strong>Developer</strong> <a href="https://twitter.com/stucoxmedia" class="twitter">@stucoxmedia</a></li>

               <li class="team"><a class="wt" href="https://github.com/patrickkettner"><img src="/i/img/Patrick-Kettner-48.jpg" width="48" height="48" alt=""/>Patrick Kettner</a> <strong>Developer</strong> <a href="http://twitter.com/patrickkettner" class="twitter">@patrickkettner</a></li>
               ...
               <li class="team"><a class="wt" href="http://www.thecssninja.com/"><img src="/i/img/Ryan-Seddon.jpeg" width="48" height="48" alt=""/>Ryan Seddon</a> <strong>Developer</strong> <a href="http://twitter.com/ryanseddon" class="twitter">@ryanseddon</a></li>
                ...
                <li class="team"><a class="wt" href="http://paulirish.com/"><img src="/i/img/Paul-Irish.jpg" width="48" height="48" alt=""/>Paul Irish</a> <strong>Developer</strong> <a href="http://twitter.com/paul_irish" class="twitter">@paul_irish</a></li>

               <li class="team"><a class="wt" href="http://farukat.es/"><img src="/i/img/Faruk-Ates.jpg" width="48" height="48" alt=""/>Faruk Ateş</a> <strong>Creator</strong> <a href="http://twitter.com/KuraFire" class="twitter">@KuraFire</a></li>
...
<!--
 ...
 -->
      ...
      <section id="the-end">
         <div class="container">
            <p class="sponsors"><a href="https://paulirish.wufoo.com/forms/p1hsxsru1ohiv0u/" class="sponsor wt">Contact Us</a> • <a href="https://github.com/Modernizr/Modernizr"  class="sponsor wt">Github</a></p>
            <!-- TODO: <a href="#credits" id="credits">credits</a> -->
            <p class="copyright" role="contentinfo">Copyright © 2009—2013. Modernizr is available under the <a href="/license/" class="wt">MIT license</a>.</p>
         </div>
      </section>
