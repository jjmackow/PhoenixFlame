...
Installation
------------
1. Create a directory sites/all/libraries/Mobile_Detect
2. Download the latest library from http://mobiledetect.net/
3. Copy the file Mobile_Detect.php to sites/all/libraries/Mobile_Detect
