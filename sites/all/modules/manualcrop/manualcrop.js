...
ManualCrop.ajaxPost = function(fid,styleName,selection) {
  //manualcrop/set/24153?full_width=0|200|540|200
  var path = "/manualcrop/set/" + fid + "?" + styleName + "=" + selection;
...
ManualCrop.selectionStored = function(element, fid, styleName) {
  ...
  ManualCrop.isLoaded('.manualcrop-file-' + fid + '-holder', function() {
    ...
    if (selection) {
      ...
      ManualCrop.ajaxPost(fid,styleName,selection);
